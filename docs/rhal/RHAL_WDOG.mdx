...
#define BIT(x)                          (1 <<x)
#endif
#define LAST_BOOT_REASON_SOFTWARE BIT(2)       
#define LAST_BOOT_REASON_BUTTION  BIT(3)       
#define LAST_BOOT_REASON_POWER    BIT(4)       
#define LAST_BOOT_REASON_WATCHDOG BIT(5)
```
...
<ParamTable
  items={[
    { name: 'p_status', type: 'int*', desc: 'buff for watchdog last boot status' },
  ]}
/>
