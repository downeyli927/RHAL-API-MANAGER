...
:::tip[tips]
This will invoke at IM initialize then you set cursor resolution to calculate like below fomular
width of cursor resolution  = cursorImageResolution.width/cursorCoordinateResolution.width
