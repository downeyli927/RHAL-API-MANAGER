...
RHAL_PCMCIA_STS_CARD_STATUS_CHANGE : Card Status Changed
RHAL_PCMCIA_STS_IREQ_ASSERT : Resume from STR
RHAL_PCMCIA_STS_CARD_AFTER_STR : Resume from STR
RHAL_PCMCIA_STS_CARD_PRESENT : Card Exists
